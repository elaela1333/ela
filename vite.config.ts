...
export default defineConfig({
  ...
  server: {
    // @ts-ignore
    allowedHosts: process.env.TEMPO === "true" ? true : 
      undefined // Whatever was the previous value or undefined
  }
});
          ...
          return [
            ...
            },
            {
              ...
              children: `
                ...
                watermark.href = 'https://www.srcbook.com?a_id=' + encodeURIComponent('01957dd8-b24c-78a7-9641-7d5d7ac7e75d');
